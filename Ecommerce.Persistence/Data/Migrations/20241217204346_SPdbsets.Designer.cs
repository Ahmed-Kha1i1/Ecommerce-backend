...
namespace Ecommerce.Persistence.Data.Migrations
{
    ...
    [Migration("20241217204346_SPdbsets")]
    partial class SPdbsets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Application.Features.Products.Queries.ProductSearchQuery.GetProductSearchQueryResponse", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductSearchResults");
                });
            ...
            modelBuilder.Entity("Ecommerce.Doman.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Ecommerce.Doman.Entities.Country", "ParentCategory")
                        .WithMany()
                        .HasForeignKey("ParentCategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
